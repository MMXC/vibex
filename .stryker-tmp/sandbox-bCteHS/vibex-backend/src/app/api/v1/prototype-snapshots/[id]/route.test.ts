...
describe('GET /api/v1/prototype-snapshots/[id]', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  ...
  it('should return snapshot by id', async () => {
    ...
    const request = new NextRequest('http://localhost:3000/api/v1/prototype-snapshots/snap1');
  ...
  it('should return 404 if not found', async () => {
    ...
    const request = new NextRequest('http://localhost:3000/api/v1/prototype-snapshots/nonexistent');
...
describe('PUT /api/v1/prototype-snapshots/[id]', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
...
describe('DELETE /api/v1/prototype-snapshots/[id]', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
