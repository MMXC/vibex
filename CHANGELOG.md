...
- **E5 CanvasListPanel**: 新增"📋 粘贴 Here"按钮（clipboard 非空时 hover 显示）+ clipboard badge（显示 N 个节点）+ CSS 样式
- **E5 DDSToolbar**: 粘贴按钮添加蓝色 badge 显示 clipboard 卡片数量（clipboardValid && count > 0 时）
