...
### Features
- **Export Profile Templates**: Named export configuration presets stored per canvas and user. Profiles bundle format (React/SVG/Markdown/JSON), scale (25-200%), node/edge inclusion flags.
- **ExportProfilesSettingsTab**: Settings drawer tab reading canvasId from DDSCanvasStore.
- **ExportProfilePanel**: Template management UI — list, create, delete profiles.
- **open-canvas-settings custom event**: ExportMenu wires to CanvasSettingsDrawer export-profiles tab.
...
### Files
- Migration: `0032_canvas_export_profiles.sql`
- Backend: `canvas/[id]/export-profiles/route.ts`, `[profileId]/route.ts`
- Frontend: `exportProfileStore.ts`, `ExportProfilePanel.tsx`, `ExportProfilesSettingsTab.tsx`
