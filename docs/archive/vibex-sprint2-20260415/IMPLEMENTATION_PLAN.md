...
| E2 | E2-U1 | 版本历史 API 集成 | 1h | P1 | — | ✅ 已完成 |
| E2 | E2-U2 | 版本列表 UI | 1h | P1 | E2-U1 | ✅ 已完成 |
| E2 | E2-U3 | Diff 查看 + 恢复 | 1h | P1 | E2-U2 | ✅ 已完成 |
| E3 | E3-U1 | JSON 导出 | 0.5h | P2 | — | ✅ 已完成 |
| E3 | E3-U2 | YAML 导出 | 0.5h | P2 | E3-U1 | ✅ 已完成 |
| E3 | E3-U3 | Round-trip 验证 | 1h | P2 | E3-U2 | ✅ 已完成 |
| E4 | E4-U1 | D1 Migration 验证 | 1h | P1 | — | ✅ 已完成 |
| E4 | E4-U2 | 三树数据序列化 | 2h | P1 | E4-U1 | ✅ 已完成 |
| E4 | E4-U3 | 三树数据恢复 | 1.5h | P1 | E4-U2 | ✅ 已完成 |
| E4 | E4-U4 | Dashboard 集成验证 | 0.5h | P1 | E4-U3 | ✅ 已完成 |
