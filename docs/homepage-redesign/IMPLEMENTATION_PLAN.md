...
| 5.2 新增动画 | 1h | 3 | pulse 动画 3s |
| 5.3 展开详情 | 2h | 4 | 摘要显示, 点击展开 |

**DoD**: [ ] 列表渲染 [ ] 最新项高亮 [ ] 展开/收起
...
| Story | 工时 | Task 数 | 关键验收 |
|-------|------|---------|----------|
| 9.1 悬浮触发 | 2h | 3 | 滚动 200px 触发 |
| 9.2 悬浮栏 | 3h | 4 | 60px 栏, 简化输入 |
...
| 10.3 SSE 连接 | 3h | 3 | 连接, 接收, 状态显示 |
| 10.4 错误重连 | 2h | 4 | 断开检测, 自动重连 3 次 |

**DoD**: [ ] 状态持久化 [ ] 快照回退 [ ] SSE 连接 [ ] 重连机制
