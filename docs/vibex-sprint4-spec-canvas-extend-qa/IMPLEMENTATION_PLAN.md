...
| E3-U2 | E5 组件存在性测试 | ✅ | E2-U1 | chapter-existence.test.ts (3 tests ✅) 确认 ChapterEmptyState/Skeleton 不存在(P0-006)，CardErrorBoundary 存在 |
...
| ID | Name | Status | Depends On | Acceptance Criteria |
|----|------|--------|-----------|---------------------|
| E4-U1 | P0/P1/P2 缺陷归档 | ✅ | E1-U1,E1-U2,E1-U3 | defects/P0/×6 + P1/×1 + P2/×2 = 9 文件，全部含 7 必需字段 |
| E4-U2 | 缺陷文件格式审查 | ✅ | E4-U1 | 全部 9 个文件含 7 必需字段 ✅ |
