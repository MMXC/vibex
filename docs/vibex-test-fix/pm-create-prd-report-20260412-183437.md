...
**项目**: vibex-test-fix
**领取 agent**: pm
**领取时间**: 2026-04-12T10:34:37.184582+00:00
**版本**: rev 3 → 4

## 项目目标
修复 vibex npm test: 3389 passed, 97 failed — 根因是 CardTreeNode 组件依赖 IntersectionObserver (jsdom 不支持)
...
- PRD 位置: docs/vibex-test-fix/prd.md
- Specs 目录: docs/vibex-test-fix/specs/
...
## 📦 产出路径
/root/.openclaw/vibex/docs/vibex-test-fix/prd.md

## 📤 上游产物
- analyze-requirements: /root/.openclaw/vibex/docs/vibex-test-fix/analysis.md
