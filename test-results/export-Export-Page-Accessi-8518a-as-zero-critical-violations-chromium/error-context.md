...
- Name: export.spec.ts >> Export Page Accessibility >> export page has zero critical violations
- Location: vibex-fronted/tests/a11y/export.spec.ts:6:7
...
```ts
  ...
  4  | 
  5  | test.describe('Export Page Accessibility', () => {
  6  |   test('export page has zero critical violations', async ({ page }) => {
  7  |     await page.goto('/canvas/export');
