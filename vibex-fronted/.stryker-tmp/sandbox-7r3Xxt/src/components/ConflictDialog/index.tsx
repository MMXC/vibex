      ...
      >
        ...
        <div className={styles.comparison} aria-label="数据对比">
          ...
          <div className={styles.comparisonRow}>
            ...
            <span className={styles.comparisonCell}>{serverCounts.contexts}</span>
            <span className={styles.comparisonCell}>{serverCounts.flows}</span>
            <span className={styles.comparisonCell}>{serverCounts.components}</span>
          </div>
          <div className={styles.comparisonRow}>
            <span className={styles.comparisonRowLabel}>本地</span>
            <span className={styles.comparisonCell}>{localCounts.contexts}</span>
            <span className={styles.comparisonCell}>{localCounts.flows}</span>
            <span className={styles.comparisonCell}>{localCounts.components}</span>
          </div>
        </div>
