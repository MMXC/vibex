...
describe('canvasStore', () => {
  ...
  // Panel collapse tests moved to uiStore.test.ts (Epic 2 — Sprint 4)
  // canvasStore delegates panel state to uiStore; toggleContextPanel/toggleFlowPanel/toggleComponentPanel live in uiStore
