...
export function navigateToSearchResult(result: SearchResult): void {
  const { useContextStore } = require('@/lib/canvas/stores/contextStore');
const { useUIStore } = require('@/lib/canvas/stores/uiStore'); as typeof import('@/lib/canvas/canvasStore');
