      ...
      >
        <button
          ...
          style={{
            padding: '8px 16px',
            backgroundColor:
              activeTab === 'general' ? '#0070f3' : 'transparent',
        ...
        <button
          ...
          style={{
            padding: '8px 16px',
            backgroundColor:
              activeTab === 'collaborators' ? '#0070f3' : 'transparent',
...
// 动态导出以禁用 SSR
export default dynamic(() => Promise.resolve(ProjectSettingsPage), {
  ssr: false,
});
