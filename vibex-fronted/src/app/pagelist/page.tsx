...
// 模拟页面数据
const mockPages = [
  { id: 1, name: '首页', path: '/', template: 'Landing', status: 'published', visits: 1250, lastEdit: '2026-02-25' },
  { id: 2, name: '关于', path: '/about', template: 'Blank', status: 'published', visits: 580, lastEdit: '2026-02-24' },
  { id: 3, name: '产品', path: '/products', template: 'Gallery', status: 'draft', visits: 0, lastEdit: '2026-02-23' },
  { id: 4, name: '联系方式', path: '/contact', template: 'Form', status: 'published', visits: 320, lastEdit: '2026-02-20' },
  { id: 5, name: '博客列表', path: '/blog', template: 'List', status: 'draft', visits: 0, lastEdit: '2026-02-18' },
  { id: 6, name: '博客详情', path: '/blog/[slug]', template: 'Article', status: 'draft', visits: 0, lastEdit: '2026-02-17' },
  { id: 7, name: '定价', path: '/pricing', template: 'Pricing', status: 'published', visits: 890, lastEdit: '2026-02-15' },
  { id: 8, name: '常见问题', path: '/faq', template: 'FAQ', status: 'published', visits: 450, lastEdit: '2026-02-14' },
]

const templates = [
  { id: 'landing', name: '落地页', icon: '🏠', description: '产品介绍、特性展示、CTA' },
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '32px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px' }}>
            ...
            <Link href="/pagelist" style={{ color: '#0070f3', fontWeight: 500, textDecoration: 'none' }}>页面管理</Link>
            <Link href="/templates" style={{ color: '#64748b', textDecoration: 'none' }}>模板库</Link>
          </div>
        </div>
        <div>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ backgroundColor: '#f8fafc' }}>
                <th style={{ padding: '14px 20px', textAlign: 'left', fontWeight: 500, color: '#64748b', fontSize: '13px' }}>页面名称</th>
                <th style={{ padding: '14px 20px', textAlign: 'left', fontWeight: 500, color: '#64748b', fontSize: '13px' }}>路径</th>
                <th style={{ padding: '14px 20px', textAlign: 'left', fontWeight: 500, color: '#64748b', fontSize: '13px' }}>模板</th>
                <th style={{ padding: '14px 20px', textAlign: 'left', fontWeight: 500, color: '#64748b', fontSize: '13px' }}>状态</th>
                <th style={{ padding: '14px 20px', textAlign: 'right', fontWeight: 500, color: '#64748b', fontSize: '13px' }}>访问量</th>
                <th style={{ padding: '14px 20px', textAlign: 'right', fontWeight: 500, color: '#64748b', fontSize: '13px' }}>最后编辑</th>
                <th style={{ padding: '14px 20px', textAlign: 'center', fontWeight: 500, color: '#64748b', fontSize: '13px' }}>操作</th>
              </tr>
            </thead>
            <tbody>
