...
jest.mock('@/services/api', () => ({
  apiService: {
    ...
    createRequirement: jest.fn().mockResolvedValue({ id: '1', content: 'Test' }),
    updateRequirement: jest.fn().mockResolvedValue({ id: '1', content: 'Updated' }),
...
describe('Requirements (/requirements)', () => {
  ...
  it('displays error message on failure', async () => {
    const { apiService } = require('@/services/api')
    apiService.createRequirement.mockRejectedValueOnce(new Error('Create failed'))
  ...
  it('handles successful requirement creation', async () => {
    const { apiService } = require('@/services/api')
    apiService.createRequirement.mockResolvedValueOnce({ id: 'new-req', content: 'Test' })
  ...
  it('handles update requirement', async () => {
    const { apiService } = require('@/services/api')
    apiService.updateRequirement.mockResolvedValueOnce({ id: '1', content: 'Updated' })
