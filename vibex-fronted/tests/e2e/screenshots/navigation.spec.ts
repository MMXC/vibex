...
test.describe('Navigation Screenshot Validation', () => {
  ...
  test('01-global-nav-dashboard-desktop', async ({ page }) => {
    ...
    // Desktop viewport
    const screenshotPath = await compareScreenshots(
      page,
  ...
  test('04-project-nav-flow-desktop', async ({ page }) => {
    ...
    const screenshotPath = await compareScreenshots(page, 'project-nav-flow', {
      width: 1920,
      height: 1080,
    });
  ...
  test('05-navigation-landing-page', async ({ page }) => {
    ...
    const screenshotPath = await compareScreenshots(page, 'nav-landing', {
      width: 1920,
      height: 1080,
    });
  ...
  test('06-navigation-templates-page', async ({ page }) => {
    ...
    const screenshotPath = await compareScreenshots(page, 'nav-templates', {
      width: 1920,
      height: 1080,
    });
  ...
  test('07-navigation-auth-page', async ({ page }) => {
    ...
    const screenshotPath = await compareScreenshots(page, 'nav-auth-login', {
      width: 1920,
      height: 1080,
    });
  ...
  test('08-navigation-auth-register', async ({ page }) => {
    ...
    const screenshotPath = await compareScreenshots(page, 'nav-auth-register', {
      width: 1920,
      height: 1080,
    });
  ...
  test('10-navigation-mobile-menu-toggle', async ({ page }) => {
    ...
    const menuButton = page
      ...
      .or(page.locator('.mobileToggle'))
      .or(page.locator('[class*="mobile"]'))
      .or(page.locator('[class*="hamburger"]'));

    // Just verify page renders correctly on mobile
    const screenshotPath = await compareScreenshots(page, 'nav-mobile-menu', {
      width: 375,
      height: 667,
    });
  ...
  test('12-navigation-user-settings', async ({ page }) => {
    ...
    const screenshotPath = await compareScreenshots(page, 'nav-user-settings', {
      width: 1920,
      height: 1080,
    });
